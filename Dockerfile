FROM ubuntu:14.04
MAINTAINER Andreas Fritzler <andreas.fritzler@sap.com>
...
RUN curl -s http://www.eu.apache.org/dist/spark/spark-1.5.0/spark-1.5.0-bin-hadoop2.6.tgz | tar -xz -C /usr/local/
